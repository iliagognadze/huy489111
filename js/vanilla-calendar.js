    ...
    function VanillaCalendar(options) {
        ...
        const createCalendar = function () {
            ...
            <div class="vanilla-calendar-header">
                <button type="button" class="vanilla-calendar-btn mtavruli brownP" data-calendar-toggle="previous"><<</button>
                <div class="vanilla-calendar-header__label" data-calendar-label="month"></div>
                <button type="button" class="vanilla-calendar-btn mtavruli brownP" data-calendar-toggle="next">>></button>
            </div>
